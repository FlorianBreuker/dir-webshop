...
<svelte:head>
  ...
  <meta name="description" content="Über uns - {WebsiteName}" />
</svelte:head>

<div class="min-h-[70vh] pb-12 pt-[5vh] container mx-auto max-w-3xl px-4 font-sans ">
  ...
  <p class="mb-8">Ein Muster zusammengesetzt aus versetzten Bildmarken, welches zur Wiedererkennung in unserem Produkt verwendet wird.</p>
</div>
