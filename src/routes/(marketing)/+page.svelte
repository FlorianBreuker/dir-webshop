<script lang="ts">
  ...
  const features = [
    {
      name: "Cloud-Speicher & Hosting",
      description:
        "Sicher auf unseren eigenen Servern gespeichert (DSGVO-konform). Starte mit 10GB gratis in der Freemium-Version.",
      link: "/pricing",
      linkText: "Pakete ansehen",
      newPage: false,
...
<path d="M17.5 9.74145C17.7095 9.53198 18.0491 9.53198 18.2586 9.74145C18.468 9.95092 18.468 10.2905 18.2586 10.5C18.0491 10.7095 17.7095 10.7095 17.5 10.5C17.2905 10.2905 17.2905 9.95092 17.5 9.74145Z" fill="#1C274C"/>`
    ...
    {
      name: "Sichere Smart Galleries",
      link: "/login",
      description:
        "Unterteile deine Shootings für Klienten. Teile passwortgeschützte Links mit Hochzeitsgästen oder Eltern von Schulkindern.",
      svgContent: `<path
    ...
    {
      name: "Integrierter Webshop",
      link: "/pricing",
      description:
        "Deine Kunden können direkt über den freigegebenen Galerie-Link Fotos als digitale Downloads oder Prints kaufen.",
  ...
  <div class="hero-content text-center py-12">
    <div class="max-w-xl">
      ...
      <div class="mt-6 md:mt-10 text-sm md:text-lg">
        Verwalte deine Kunden, teile passwortgeschützte Galerien mit Hochzeitsgästen oder Schulen und verkaufe deine Bilder automatisiert über unseren integrierten Webshop.
      </div>
      <div
        class="mt-6 md:mt-10 flex flex-row flex-wrap gap-4 place-content-center"
      >
        <a href="/login">
  ...
  <div class="pt-20 pb-8 px-7">
    <div class="max-w-lg mx-auto text-center">
      ...
      <div class="mt-4 text-xl font-bold">
        Alles, was du für dein Fotografie-Business brauchst, auf
        <span
    ...
    >
      {#each features as feature}
        <div class="card bg-base-200 w-[270px] min-h-[300px] flex-none shadow-xl">
          <div class="card-body items-center text-center p-[24px] pt-[32px]">
            ...
            {#if feature.link}
              ...
              >
                ...
                >{feature.linkText ? feature.linkText : "Mehr erfahren"}</button
                >
              </a>
            {/if}
          </div>
